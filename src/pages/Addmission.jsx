    ...
    <div className="main-layout">
        ...
        <div className="page-container">
            <div className="content">
                <h1 className="title1">Addmission at Vivekanand College</h1>
                ...
                <h2 className="title2">Eligibility Criteria for Undergraduate Program</h2>
                ...
                <h2 className="title2">Application Process</h2>
                <ol>
                ...
                <p className="p">For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our 
                    <a href="/courses" data-discover="true">Contact Page</a>
                    "or"
                    <a href="/contact" data-discover="true">Contact us</a>
                    "directly."
                </p>
